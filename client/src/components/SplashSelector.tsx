          ...
          <div className={`flex items-center gap-3 mb-4 md:mb-5 px-3 py-2.5 rounded-2xl transition-all duration-500 ${
            ...
            <div className="flex flex-col justify-center min-w-0 flex-1">
              ...
              <div className="flex items-center gap-2 mt-0.5">
                <h1 className="text-white text-xs md:text-sm font-semibold tracking-wider uppercase leading-tight">
                  Bienvenido a Nutriser
                </h1>
                {/* Botón WhatsApp dorado brillante */}
                <a
                  href="https://wa.me/523221007799?text=Hola%2C%20me%20interesa%20conocer%20m%C3%A1s%20sobre%20los%20servicios%20de%20Nutriser"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-shrink-0 flex items-center justify-center w-7 h-7 rounded-full bg-gradient-to-br from-[#C5A55A] via-[#E8C97A] to-[#C5A55A] shadow-[0_0_10px_rgba(197,165,90,0.7),0_0_20px_rgba(197,165,90,0.4)] hover:shadow-[0_0_14px_rgba(197,165,90,0.9),0_0_28px_rgba(197,165,90,0.6)] hover:scale-110 active:scale-95 transition-all duration-200"
                  aria-label="Contactar por WhatsApp"
                  title="Escríbenos por WhatsApp"
                >
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-[#1A1A1A]" xmlns="http://www.w3.org/2000/svg">
