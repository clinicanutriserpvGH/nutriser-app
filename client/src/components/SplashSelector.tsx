...
const CLINIC_IMG2 =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663459263490/7jSTACnGYyADJrX65GKurG/nutriser-sala-espera_9105457e.png";
const PORTAL_IMG =
        ...
        <div className="w-full max-w-[480px] md:max-w-[700px] lg:max-w-[960px]">
          ...
          <div className="flex items-center justify-center gap-4 mb-5">
            ...
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-11 h-11 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 active:scale-95 transition-all duration-200" style={{ background: 'linear-gradient(135deg, #C5A55A 0%, #E8D5A3 50%, #A8893F 100%)' }}>
