        ...
        <div className="w-full max-w-[480px] md:max-w-[700px] lg:max-w-[960px]">
          ...
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <a
              ...
              className="w-10 h-10 rounded-xl bg-[#25D366] flex items-center justify-center shadow-md hover:scale-110 active:scale-95 transition-all duration-200"
            ...
            <a
              ...
              aria-label="Cómo llegar a Nutriser"
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white" xmlns="http://www.w3.org/2000/svg">
