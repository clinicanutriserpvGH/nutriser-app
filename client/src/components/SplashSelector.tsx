        ...
        <div className="w-full max-w-[520px] md:max-w-[800px] lg:max-w-[1100px]">
          ...
          <div className="flex flex-col gap-2 md:gap-3 mb-4">
            ...
            {!emailDone ? (
              !showEmailForm ? (
                ...
                >
                  ...
                  <span className="text-xs md:text-sm">Suscríbete a nuestra Cuponera de Descuentos Nutriser</span>
                </button>
              ) : (
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              {pushEnabled ? (
                <div
                  className="relative flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#C5A55A]/20 border-2 border-[#C5A55A]/60 flex items-center justify-center"
                  title="Notificaciones activas"
                >
                  <Bell className="w-6 h-6 md:w-7 md:h-7 text-[#C5A55A]" />
                ...
                <div className="relative flex-shrink-0">
                  ...
                  <span className="absolute inset-0 rounded-full bg-[#C5A55A] opacity-40 animate-ping" style={{ animationDuration: "2s" }} />
                  <button
                    onClick={() => setShowNotifModal(true)}
                    className="relative w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#C5A55A] flex items-center justify-center shadow-lg shadow-[#C5A55A]/50 hover:bg-[#B8963E] hover:scale-110 active:scale-95 transition-all duration-300"
                    aria-label="Activar notificaciones de descuentos"
                  >
              ...
              <a
                ...
                className="relative flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-all duration-300"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="relative flex-shrink-0 w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#1877F2] flex items-center justify-center shadow-lg shadow-[#1877F2]/40 hover:bg-[#166fe5] hover:scale-110 active:scale-95 transition-all duration-300"
                aria-label="Facebook"
              >
                <svg viewBox="0 0 24 24" className="w-6 h-6 md:w-7 md:h-7 fill-white" xmlns="http://www.w3.org/2000/svg">
