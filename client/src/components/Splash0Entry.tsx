    ...
    >
      ...
      >
        <div className="w-full max-w-[480px] sm:max-w-[600px] md:max-w-[780px] lg:max-w-[1100px] xl:max-w-[1300px] 2xl:max-w-[1500px] flex flex-col h-full">
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-4 lg:gap-6 mb-4 mt-1 flex-nowrap w-full overflow-x-auto px-1">
            ...
            >
              <div className="w-11 h-11 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl flex items-center justify-center shadow-md group-hover:scale-110 active:scale-95 transition-all duration-200"
                style={isLight
                  ...
                  : { background: 'linear-gradient(145deg, #C5A55A 0%, #d4b46a 100%)', border: '1px solid rgba(197,165,90,0.6)' }}>
                <CalendarCheck className="w-5 h-5 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-black" />
              </div>
              <span className={`text-[9px] sm:text-[10px] font-medium text-center leading-tight ${isLight ? 'text-[#9a8050]' : 'text-[#C5A55A]/80'}`}>Agendar<br/>Cita</span>
            </a>
            ...
            <a href="https://wa.me/523221007799?text=Hola%2C%20me%20interesa%20agendar%20una%20valoraci%C3%B3n%20en%20Nutriser" target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-11 h-11 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-2xl flex items-center justify-center shadow-md group-hover:scale-110 active:scale-95 transition-all duration-200"
                ...
                <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-7 sm:h-7 lg:w-8 lg:h-8" style={{ fill: isLight ? '#7a6030' : 'white' }} xmlns="http://www.w3.org/2000/svg">
              ...
              <span className={`text-[9px] sm:text-[10px] font-medium ${isLight ? 'text-[#9a8050]' : 'text-[#C5A55A]/80'}`}>WhatsApp</span>
            </a>
            ...
            <a href="https://instagram.com/nutriserpv" target="_blank" rel="noopener noreferrer"
              ...
              <span className={`text-[9px] sm:text-[10px] font-medium ${isLight ? 'text-[#9a8050]' : 'text-[#C5A55A]/80'}`}>Instagram</span>
            </a>
            ...
            <a href="https://facebook.com/nutriserpv" target="_blank" rel="noopener noreferrer"
              ...
              <span className={`text-[9px] sm:text-[10px] font-medium ${isLight ? 'text-[#9a8050]' : 'text-[#C5A55A]/80'}`}>Facebook</span>
            </a>

            {/* Correo */}
            <a
              href="mailto:clinicanutriserpv@gmail.com?subject=Consulta%20Nutriser"
              onClick={e => { e.preventDefault(); window.open('mailto:clinicanutriserpv@gmail.com?subject=Consulta%20Nutriser', '_self'); }}
              ...
              <span className={`text-[9px] sm:text-[10px] font-medium ${isLight ? 'text-[#9a8050]' : 'text-[#C5A55A]/80'}`}>Correo</span>
            </a>
            ...
            <a href="https://maps.google.com/?q=Nutriser+Aesthetic+%26+Nutrition+Puerto+Vallarta"
              ...
              <span className={`text-[9px] sm:text-[10px] font-medium ${isLight ? 'text-[#9a8050]' : 'text-[#C5A55A]/80'}`}>Ubicación</span>
            </a>
