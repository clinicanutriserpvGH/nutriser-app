...
import {
  ...
  MapPin, Pill, Ruler, Share2, ShoppingBag, ShoppingCart, Sparkles, Tag,
        ...
        <div className="w-full max-w-[480px] md:max-w-[700px] lg:max-w-[960px]">
          ...
          <div className="flex items-center justify-center gap-4 mb-5">
            ...
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-11 h-11 rounded-xl bg-[#25D366] flex items-center justify-center shadow-md group-hover:scale-110 active:scale-95 transition-all duration-200">
              ...
              <span className="text-white/50 text-[9px] font-medium">WhatsApp</span>
            </a>
            ...
            <a href="https://instagram.com/nutriserpv" target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-11 h-11 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 active:scale-95 transition-all duration-200"
              ...
              <span className="text-white/50 text-[9px] font-medium">Instagram</span>
            </a>
            ...
            <a href="https://facebook.com/nutriserpv" target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-11 h-11 rounded-xl bg-[#1877F2] flex items-center justify-center shadow-md group-hover:scale-110 active:scale-95 transition-all duration-200">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white" xmlns="http://www.w3.org/2000/svg">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </div>
              <span className="text-white/50 text-[9px] font-medium">Facebook</span>
            </a>
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=clinicanutriserpv@gmail.com&su=Consulta%20Nutriser"
              ...
              <div className="w-11 h-11 rounded-xl bg-[#D44638] flex items-center justify-center shadow-md group-hover:scale-110 active:scale-95 transition-all duration-200">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                </svg>
              </div>
              <span className="text-white/50 text-[9px] font-medium">Correo</span>
            </a>
            ...
            <a href="https://maps.google.com/?q=Nutriser+Aesthetic+%26+Nutrition+Puerto+Vallarta"
              ...
              <span className="text-white/50 text-[9px] font-medium">Ubicación</span>
            </a>
